...
class Graph {
 ...
 public:
  ...
  Graph(): points_(), nodes_(), edges_(), n_size_(0), e_size_(0){
    // HW0: YOUR CODE HERE
  }
  ...
  Node add_node(const Point& position) {
    ...
    ++n_size_;
    nodes_.push_back(Node(this, n_size_ - 1));
  ...
  bool has_edge(const Node& a, const Node& b) const {
    ...
    for (Edge e: this->edges_){
      size_type a2 = e.node1().index();
      size_type b2 = e.node2().index();
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    if  (this->has_edge(a,b) == true){
      ...
      for (size_type i=0; i<this->e_size_; i++){
        e = this->edges_[i];
        size_type a2 = e.node1().index();
        size_type b2 = e.node2().index();
        if ((a1 == a2 and b1  == b2) or (a1 == b2 and b1  == a2)){
      ...
      ++e_size_;
      edges_.push_back(Edge(this, a.index(), b.index(), e_size_ - 1));
      idx = e_size_ - 1;
    }
    return edges_[idx];
  }
