 ...
 public:
  ...
  class Edge {
   public:
    ...
    Node node1() const {
      // HW0: YOUR CODE HERE
      return Node(graph_e, graph_e->edges.at(idx_e).first);    
      //return Node();  
    }
    ...
    Node node2() const {
      // HW0: YOUR CODE HERE
      return Node(graph_e, graph_e->edges.at(idx_e).second);        
      //return Node();
    }
   ...
   private:
    ...
    Edge(const Graph* graph, size_type idx)
      :graph_e(const_cast<Graph*>(graph)), idx_e(idx) {
    }
  };
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    if (has_edge(a, b)) return Edge(this, node_edge[a.idx_n][b.idx_n]);
    else {
