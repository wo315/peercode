...
class Graph {
 ...
 public:
  ...
  Node add_node(const Point& position) {
    ...
    node_vector.emplace_back(num_nodes_, position, adj_nodes);
 ...
 private:
  ...
  struct pnode {
    ...
    Point point;
    std::vector<neighbors> adj_nodes;
    pnode(size_type idx, Point point, std::vector<neighbors> adj_nodes) 
      :idx(idx), point(point), adj_nodes(adj_nodes) {}
  };
