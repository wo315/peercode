...
class Graph {
 ...
 public:
  ...
  Edge add_edge(const Node& a, const Node& b) {
    ...
    if (node_to_edges.count(a.index))
      node_to_edges.insert(a.index, std::set<size_type>());
    node_to_edges[a.index].insert(e.index);

    if (node_to_edges.count(b.index))
      node_to_edges.insert(b.index, std::set<size_type>());
    node_to_edges[b.index].insert(e.index);
 ...
 private:
  ...
  std::map<size_type, std::set<size_type>> node_to_edges;
