...
class Graph {
  ...
  class Node {
    ...
    bool operator==(const Node& n) const {
      // HW0: YOUR CODE HERE //(void) n; // Quiet compiler warning
      return (n.index()==idx_
           && n.position()==((*graph_).nodes.find(idx_)->second));
    }
  ...
  Node add_node(const Point& position) {
    // HW0: YOUR CODE HERE //(void) position;
  ...
  bool has_node(const Node& n) const {
    //HW0 HERE //(void) n; //Quiet compiler warning
  ...
  Node node(size_type i) const {
    assert(i<nodes.size());
    //HW0 HERE //(void) i; //Quiet compiler warning
    return Node(this,i);
  }
  ...
  class Edge {
    ...
    bool operator==(const Edge& e) const {
     //HW0 HERE // (void) e; // Quiet compiler warning
      Node cn1=this->node1();
      Node cn2=this->node2();
      Node en1=e.node1();
      Node en2=e.node2();
  ...
  bool has_edge(const Node& a, const Node& b) const {
    // HW0 HERE //(void) a; (void) b; // Quiet compiler warning
