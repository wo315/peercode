 ...
 public:
  ...
  class Node {
   public:
    ...
    bool operator==(const Node& n) const {
      // HW0: YOUR CODE HERE
	  if (graph_==n.graph_ and node_idx==n.node_idx){
		  return true;
	  }
      return false;
    }
  ...
  class Edge {
   public:
    ...
    Node node1() const {
      // HW0: YOUR CODE HERE
      return Node(graph_,graph_->edge2node[edge_idx][0]);
    }

    /** Return the other node of this Edge */
    Node node2() const {
      // HW0: YOUR CODE HERE
      return Node(graph_,graph_->edge2node[edge_idx][1]); 
    }
  ...
  Edge add_edge(const Node& a, const Node& b) {
    // HW0: YOUR CODE HERE
	if (has_edge(a, b)){
		return Edge(this, node2node[a.index()][b.index()]);
	}
