...
class Graph {
 ...
 public:
  ...
  Graph() : size_(0), num_edges_(0), next_uid_(0), nodes_(), adjacency_list_(),edge_ptrs_(){
    // HW0: YOUR CODE HERE
  }
  ...
  Node add_node(const Point& position) {
    node_element new_element = {position, next_uid_};
  ...
  class Edge {
   public:
     ...
     */
    bool operator<(const Edge& e) const {
      return ((uintptr_t)node_1_ * (uintptr_t)node_2_)<((uintptr_t)e.node_1_ * (uintptr_t)e.node_2_);
    }
