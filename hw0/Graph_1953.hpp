...
class Graph {
 ...
 private:
    ...
    std::unordered_map<size_type, Point> internal_nodes;
    std::unordered_map<size_type, std::array<size_type,2>> internal_edges; 
    //edges_uid -> //(n1,n2)
  // HW0: YOUR CODE HERE
 ...
 public:
  ...
  Graph()
    : nodes_size_(0), nodes_uid_(0), edges_size_(0), edges_uid_(0), internal_nodes(), internal_edges() {}
  ...
  class Node {
   ...
   public:
     ...
     */
    Node() {
      // insert some nullpointer to graph
      // HW0: YOUR CODE HERE
    }
    ...
    const Point& position() const {
      ...
      /* for (size_type i = 0; i< graph_->size(); ++i)
        if (graph_->internal_nodes[i].uid == uid_)
          return graph_->internal_nodes[i].position; */
  ...
  Node add_node(const Point& position) {
    ...
    nodes_uid_++;
    nodes_size_++;
    return Node(this, nodes_uid_-1);        // Invalid node
  }
